...
| Email OTP | Real | Request code and verify code work; onboarding now lands here directly, and OTP delivery uses live Resend when configured | Still a web-auth surface, not source-equal mobile UI |
