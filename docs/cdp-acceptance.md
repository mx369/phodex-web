...
| Turn Empty | Same authenticated session, opened a clean chat after the empty-timeline and typography-tightening passes | `.artifacts/qa-71-turn-empty-timeline-block.png`, `.artifacts/qa-cdp/qa-104-turn-empty-final-typography-tightened.png` |
...
| Turn View Composer Controls | Same authenticated session, reopened the Todo-maintenance thread after the UI-standards, secondary-type cleanup, and collapsed-composer baseline pass and verified the tighter default composer height plus the smaller send/stop controls now sitting on the toolbar baseline | `.artifacts/qa-cdp/qa-90-thread-controls-ui-standards.png`, `.artifacts/qa-cdp/qa-93-thread-ui-tightened.png`, `.artifacts/qa-cdp/qa-95-thread-ui-tightened-2.png`, `.artifacts/qa-cdp/qa-97-thread-bottom-send-tightened.png`, `.artifacts/qa-cdp/qa-99-turn-send-baseline-tightened.png` |
...
| Sidebar Open | Same authenticated session, opened the drawer after the drawer parity, UI-standards, and secondary-type/icon cleanup passes | `.artifacts/qa-76-drawer-open.png`, `.artifacts/qa-cdp/qa-88-drawer-ui-standards.png`, `.artifacts/qa-cdp/qa-96-drawer-ui-tightened-2.png` |
