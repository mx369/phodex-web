...
| Turn View Composer Controls | Same authenticated session, reopened the Todo-maintenance thread after the UI-standards and secondary-type cleanup passes and verified the smaller send/stop controls plus the tighter composer/footer scale | `.artifacts/qa-cdp/qa-90-thread-controls-ui-standards.png`, `.artifacts/qa-cdp/qa-93-thread-ui-tightened.png`, `.artifacts/qa-cdp/qa-95-thread-ui-tightened-2.png`, `.artifacts/qa-cdp/qa-97-thread-bottom-send-tightened.png` |
